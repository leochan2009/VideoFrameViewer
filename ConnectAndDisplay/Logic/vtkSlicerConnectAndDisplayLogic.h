...
// .NAME vtkSlicerConnectAndDisplayLogic - slicer logic class for volumes manipulation
// .SECTION Description
// This class manages the logic associated with reading, saving,
// and changing propertied of the volumes


#ifndef __vtkSlicerConnectAndDisplayLogic_h
#define __vtkSlicerConnectAndDisplayLogic_h
...
#include "vtkSlicerConnectAndDisplayModuleLogicExport.h"

class vtkMRMLIGTLConnectorNode;
/// \ingroup Slicer_QtModules_ExtensionTemplate
class VTK_SLICER_CONNECTANDDISPLAY_MODULE_LOGIC_EXPORT vtkSlicerConnectAndDisplayLogic :
